...
def reservation_view(request, room_id):
    if request.method=="POST":
        ...
        reservation = Reservation(hotelRoom = hotelRoom, begin_at=check_in, ends_at=check_out, observations=observations,phone=phone, first_name=first_name, last_name=last_name)
        reservation.save()
